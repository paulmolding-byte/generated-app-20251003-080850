...
export default {
  ...
  theme: {
  	extend: {
        ...
        'glow-neon-magenta': '0 0 8px #FF00FF, 0 0 16px #FF00FF, 0 0 24px #FF00FF',
        'glow-neon-cyan': '0 0 8px #00FFFF, 0 0 16px #00FFFF, 0 0 24px #00FFFF',
        'glow-neon-yellow': '0 0 8px #FFFF00, 0 0 16px #FFFF00, 0 0 24px #FFFF00',
  		},
  		keyframes: {
  			'fade-in': {
  				'0%': {
